...
export function Dashboard() {
  ...
  return (
    <div className="flex h-screen bg-background w-full">
      <Sidebar collapsible="offcanvas" className="bg-card/25 backdrop-blur-xl border border-border rounded-2xl shadow-lg border-r m-3 transition-transform duration-300 ease-in-out">
